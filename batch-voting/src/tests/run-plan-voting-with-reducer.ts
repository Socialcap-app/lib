...
import { PlanVotingContractWithReducer } from '../PlanVotingContractWithReducer.js';
...
// first compile it
await PlanVotingContractWithReducer.compile();
...
let zkApp = new PlanVotingContractWithReducer(zkAppAddr);
